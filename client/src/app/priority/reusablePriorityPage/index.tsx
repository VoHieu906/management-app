...
import { dataGridClassNames, dataGridSxStyles } from "@/lib/ultis";
import {
  Priority,
  Task,
  useGetAuthUserQuery,
...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    width: 130,
    renderCell: (params) => (
      <span className="inline-block rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">
        {params.value}
      </span>
    ),
  },
